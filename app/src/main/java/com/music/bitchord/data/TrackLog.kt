 ...
 * BitChord to access all device logs?"* â€” which appears whenever the process
...
object TrackLog {
    ...
    private fun header(
        ...
        appendLine("BitChord log â€” ${song.title} â€” ${song.artist}")
        ...
        appendLine(
            "window: ${from?.let { CLOCK.format(Date(it)) } ?: "everything held"} â†’ " +
