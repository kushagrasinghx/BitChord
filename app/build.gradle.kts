...
android {
    ...
    productFlavors {
        create("dev") {
            ...
            resValue("string", "app_name", "BitChord Offline Dev")
        }
        create("prod") {
            dimension = "env"
            resValue("string", "app_name", "BitChord Offline")
        }
    }
...
dependencies {
    ...
    // Local playback and media controls only.
    ...
    // Local artwork/theming. No HTTP image loader artifact.
    ...
    // Local encrypted settings and on-device analysis.
